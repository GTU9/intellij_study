...
public class A_break {
    ...
    public void testSimpleBreakStatement(){
        ...
        * 해당 반복문을 빠져 나올때 사용하며, 반복문의 조건문 판단 결과와 상관없이
        * 반복문을 빠져나올때 사용한다.
    ...
    public void testSimpleBreakStatement2(){
        /*중첩 반복문 내 break문 사용에 대한 흐름을 이해하고 적용할 수 있디.*/
        /*break는 모든 반복문을 종료한는 것이 아닌, 자신에게 가장 인접한 반복문 실행만 멈춘다*/
    ...
    public void testJumpBreak(){
       /*중첩 반복 내 break문 사용 시 jump(goto)에 대한 흐름을 이해하고 적용할 수 있다.*/
        label:
        for(;;){
            for(int i=0;i<10;i++){
