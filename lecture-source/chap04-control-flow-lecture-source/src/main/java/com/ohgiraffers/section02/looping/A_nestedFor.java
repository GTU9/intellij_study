...
public class A_nestedFor {
    ...
    public void printGugudanFromTwoToNine(){
        ...
        for(int dan =2; dan<10;dan++){
            ...
            /*단이 1개씩 증가하는 동안 수행할  내용은 해단 단의 구구단을 출력하는 것이다.*/
    ...
    public void printUpgaradeGugudanFromTwoToNine(){
    ...
    public void printGugudanOf(int dan){
        /*매개변수로 전달 받은 단을 1~10까지 곱한 내용을 출력해준다. */
        for(int su=1; su<10;su++){
            System.out.println(dan+ " * "+su+" = "+(dan*su));
        }
    }
    ...
    public void printStarInputRowTimes(){
        ...
        /*키보드로 정수를 하나 입력 받아 해당 정수 만큼 한 행에"*"을 5개씩 출력해보자*/
...
//            }
    ...
    public void printStar(int time){
        for(int j=1;j<6;j++){
            System.out.print("*");
        }
    }
    ...
    public void printTriangleStars(){
        ...
        /*키보드로 정수를 하나 입력 받아 해당 정수 만큼 한 행에 "*"을 행의 번호 개씩 출력해보자
        * 예시) 정수를 입력하세요 : 5
        *  *
        *  **
        *  ***
