...
public class Application2 {
    public static void main(String[] args) {
        ...
        * */
        ...
        /*2. 값 배열의 인덱스에 접근해서 값 대입 후 출력*/
        /*2-1. 배열의 각 인덱스 공간에 하나씩 접근하여 값 대입후 출력*/
        /*값 출력*/
        ...
        * */
        ...
        /*배열 인덱스를 하나씩 증가시키며 0번쨰 인덱스부터 마지막 번쨰 인덱스까지 차례로  인덱스*/
        ...
        * 모든 인덱스의 값을 출력하고 나면 다음 배열도 순차적으로 접근해서 출력하면서
        * 매 배열의 값을 다 출력할 때 마다 한 줄씩 라인을 바꿔주는 행위를 배열의 갯수만큼 반복하고 있다.*/

        /*배열의 갯수만큼 배열에 하나씩 반복적으로 접근하기 위한 용도의 반복문*/
        for(int i=0;i< iarr.length;i++){

            /*각 배열에 접근했을 때 해당 배열의 값을 처음 인덱스부터 차례로 접근하여 출력해주는 반복문*/
            for(int j=0;j<iarr[i].length;j++){
