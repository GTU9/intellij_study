...
//        iarr1 = new int[][4];
        ...
        * 서로 같은 길이의 여러 개의 배열을 하나로 묶어 관리하는 2차원 배열을 가변 배열이라고 한다.
        * */

        iarr2=new int[3][4];

        /*4. 각 배열의 인덱스에 차례로 접근해서 값 출력*/
        /*할당 훙에 아무 값을 대입하지 않아도 heap 영역에는 값이 없는 상태로 공간을 생성할 수 없기 때문에 기본값이 들어있다.*/
        ...
        * 따라서 한 개 인덱스가 가진 배열의 값을 출력하는 반복문을 3번 반복하는  반복문을 작성 해보자.
        * */
