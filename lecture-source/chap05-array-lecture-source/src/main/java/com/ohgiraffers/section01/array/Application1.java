...
public class Application1 {
    public static void main(String[] args) {
        /*배열에 대해 이행하고 배열의 사용 목적을 이해할 수 있다.*/
        /*배열이란?
        ...
        * */
        ...
        /* 변수 5개에 값을 저장 한다.
        * 이떄 사용자(개발자)는 변수의 이름을 모두 알아야 한다.
        * */
        int num1=10;
        int num2=20;
        int num3=30;
        ...
        * */
        ...
        /*하나의 이름으로 관리되는 연속된 메모리 공간이고 찾아갈 수 있는 번호(인덱스)를 이용해 접근한다.*/
        arr[0]=10;
        arr[1]=20;
        arr[2]=30;
        arr[3]=40;
