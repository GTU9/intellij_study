...
public class Application1 {
    public static void main(String[] args) {
         ...
         * 쉽게 말해 우리가 구현할 수 없거나 구현하기 번거로운 기능들을 jdk를 설치하면 사용할 수 있도록 제공해 놓은
        ...
        /*1-2. import를 해서 사용*/
        /*클래스의 full-name 말고 클래스명만 작성하려면 import를 배워야 한다고 배웟다.
        * 하지만 Math 클래스는 import 하지 않아도 쓸 수 있다.
        * java.lang 패키지에 속한 클래싀기 때문이다.
        * System, String 또한 지금까지 따로 import 하지 않고 사용할 수 있었던 것은 두 클래스 또한 java.lang 패키지에 속하기 떄문이다.
        * 워낙 자주 사용하는 패키지이다 보니 import 하지 않고 사용할 수 있도록 해 놓았다.
        * 컴파일러가 import java.lang.*; 이 코드를 추가해서 컴파일을 하기 떄문이다.
        * */
