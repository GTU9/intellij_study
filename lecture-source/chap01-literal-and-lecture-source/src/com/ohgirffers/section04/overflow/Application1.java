package com.ohgirffers.section04.overflow;

public class Application1 {
    public static void main(String[] args) {
        /*오버 플로우*/
        /*자료형 별 값의 최대 범위를 벗어나는 경우*/
        /*발생한 carry를 버림처리 하ㅗ sign bit를 반전시켜 최소값으로 순환시킴
        * */
        ...
        /*언더 플로우*/
        /*언더 플로우와 반대 개념으로 최소 범위보다 작은 수를 발생시키는 겨우 발생하는 현상이다.*/
        ...
        * */
        ...
        /*이런한 현상이 발생해도 그냥 넘기는 경우가 발생할 수 있다.
        * 이런 경우를 논리적 에러라고 표현한다.*/
        ...
        /*이미 오버플로우 처리된 결과를 가지고 변수에 담기 떄문에 위에 결과와 별 차이는 없다.*/
