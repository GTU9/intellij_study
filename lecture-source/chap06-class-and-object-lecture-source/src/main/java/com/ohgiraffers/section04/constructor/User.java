...
//        this.enrollDate = enrollDate;
              ...
              /*id,pwd,name 필드를 초기화하는 긴ㅇ을 가진 생성자를 바로 위에서 작성했었다.
               *  따라서 중복되는 초기화 내용이 발생하게 되는데, 이 중복되는 초기화 내용을 줄여서 작성할 수 있다.
               * */

              /*this() 사용하기
               * this()는 동일 클래스에 내에 작성한 다른 생성자 메소드를 호출하는 구문이다.
    ...
    * 동일한 값을 가지지만 새롭게 할당되는 인스턴스이기 때문에 서로 다른 주소값을 가진다. (깊은복사)
    * */
...
//        this.enrollDate=otherUser.enrollDate;
        ...
        /*this의 주소와 otherUser의 주소가 다른지 확인*/
        System.out.println("this의 hashcode : "+this.hashCode());
        System.out.println("User의 hashcode : "+otherUser.hashCode());
    }
