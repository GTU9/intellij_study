...
public class Application {
    public static void main(String[] args) {
        ...
        /*객체 지향 프로그래밍이란
        * 현실세계의 모든사건(event)는 객체와 객체의 상호작용에 의해 일어난다는 세계관을
        * 프로그램을 만들 때 이용하여 새로운 세계를 창조하는 방법론이다.
        * 현실 세계와 닮아있지만 현실 세계와 다른 점은 객체간의 상호 작용을 한다는 사실이
        * 현실 세계와 동일하지만 의인화 기법이 적용되어
        * 현실 세계에서 불가능한 무생물이나 개념 같은 존재들도 한나의 주체로
        ...
        * 설계하는 것을 의미한다.
        * 즉, 필드보다는 메소드를 중접으로 추상화 기법을 적용하여 객체를 설계하고,
        ...
        * 2. 자동차는 시동거리, 앞으로 가기, 멈추기, 시동 끄기를 할 수 있다.
        * 3. 자동차는 처음에 멈춘 상태로 대기하고 있는다.
        * 4. 카레이서는 먼저 자도아에 시동을 건다. 이미 걸려있는 경우 다시 시동을 걸 수 없다.
        * 5. 카레이서가 엑셀레이터를 밟으면 시동이 걸린 상태일 경우 자동차는 시속이 10km/h 증가하며 앞으로 나아간다.
        ...
        *   -행위: 시동을 걸어라, 앞으로 가라, 멈춰라, 시동을 꺼라*/
        ...
        while (true){
            ...
            switch (no){
                ...
                case 2 : racer.stepAccelater();break;
                case 3 : racer.stepBreak();break;
                case 4 : racer.turn0ff();break;
                case 9 :
