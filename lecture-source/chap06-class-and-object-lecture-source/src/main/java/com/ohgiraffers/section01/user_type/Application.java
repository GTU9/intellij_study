...
public class Application {
    public static void main(String[] args) {
        ...
        int age =20;
        char gender='남';
        String[] hobby=new String[]{"농구", "수영", "달리기"};
        ...
        * 3. 리턴은 1개의 값만 가능하기 떄문에 회원정보를 묶어서 리턴값으로 사용할 수 없다. (서로 다른 자료형들이기 때문)
        * */

        /*그래서 자바에서는 서로 다른 자료형의 데이터를 사용자(개발자) 정의로 하나로 묶어서 새로운 타입을 정의할 수 이쓴ㄴ 방벙을 제공해준다.
        * 필요로 하는 자료형이 추가로 존재하는 경우 자바에서 클래스라는 메커니즘을 이용해서 사용자 정의의 자료형을 만들 수 있게 한다.
        ...
        * */
        ...
        /*2. 사용자 저읭의 자료형 사용하기*/
        /*2-1. 변수 선언 및 객체 생성*/
        /*자료형 변수명 = new 클래스명(); <- 지금까지 사용한 이구문은 객체(instance)를 생성하는 구문이다.
        ...
        * heap에 생성되기 떄문에 jvm 기본값으로 초기화 된다.
        * */
        ...
        * */
        ...
        member.age =20;
        member.gender='남';
        member.hobby=new String[]{"농구", "수영", "달리기"};

        /*값이 변경되어 있는지 다시 확인 해 보자*/
