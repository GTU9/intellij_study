...
public class Application1 {
    public static void main(String[] args) {
        ...
        * 하나의 래퍼런스변수에 저장된 주소값을 가지고 배열의 내용을 수정(값 변경)을 하게 되면
        * 다른 레퍼런스변수로 배열에 접근했을 때도 동일한 배열을 가리키고 있기 떄문에 변경된 값이 반영되어 있다.
        * */
        ...
        /*hashcode를 출력해보면 두개의 레퍼런스변수는 동일한 주소를 가지고 있는 것을 볼 수 있다.*/
         ...
         * 복사본 배열의 값을 변경했음에도 원본 배열에 영향을 미치는 것을알수 있다.
         * 서로 같은 배열을 가리키고 있기 때문이다. (현재 존재하는 배열은 하나이다.)*/
