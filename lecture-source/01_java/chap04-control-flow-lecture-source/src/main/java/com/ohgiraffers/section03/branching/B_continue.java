...
public class B_continue {
    ...
    public void testSimpleContinueStatement(){
        ...
        /*contunue문은 반복문 내에서 사용한다.
        * 해당 반복문의 반복 회차를 중간에 멈추고 다시 증감식으로 넘어가게 해준다.
        * 이반적으로 if(조건식) {continue;} 처럼 사용된다.
        * 보통 반복문 내에서 특정 조건에 대한 예외를 처리하고자 할 떄 자주 사용된다.
        * */

        /*1부터 100사이의 4의 배수이면서 5의 배수인 값 출력*/
        for(int i=1;i<=100;i++){
            if(i%4==0&&i%5==0){
                /*i와 값이 4와5의 공배수인 경우 i값 출력*/
        ...
        * 단 각 단의 수가 짝수인 경우 출력을 생략한다.*/
        ...
        for (int dan=2;dan<10;dan++){
            ...
            for(int su=1;su<10;su++){
                if(su%2==0){
                    /*su가 짝수인 경우 해당 회차 반복 내용을 건너 뛰고 해당 반복문을 빠져나간다.*/
                    continue;
                }
