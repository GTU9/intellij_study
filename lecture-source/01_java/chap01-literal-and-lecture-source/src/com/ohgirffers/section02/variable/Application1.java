package com.ohgirffers.section02.variable;

public class Application1 {
    public static void main(String[] args) {
        /*변수의 사용 목적*/
        /*1. 값에 의미를 부여하기 위한 목적(의미 전달이 쉬워야 코드를 읽기 쉬워지고, 협업 및 유지보수에 유리하기 떄문이다.
        * 2. 한번 저장해둔 값을 재사용 하기 위한 목적(변수를 이용하여 코드를 작성하면 값을 변경 할때도 보다 간편하게 변경할 수 있다.)
        * 3. 시간에 따라 변하는 값을 저장하고 사용할 수 있다.(변하는 값을 저장하기 위한 공간이다.)
        * */

        /*1. 값에 의미를 부여하기 위한 목적*/
        System.out.println("=================값에 의미 부여 테스트====================");
        /*아래 처럼 작성하면 어느 값이 급여인지 어는 값이 보너스 금액인지 알 수 없다.*/
        System.out.println("보너스를 포함한 급여 : "+(1000000+200000)+"원");
        /*정수가 담길 수 있는 공간인 int형으로 해 놓으면 백만이 들어갔지만, 샐러리=급여라는 것을 알 수 있고, 2십만원은 보너스 값이구나 라는 것을 이해할 수 있다. */
        int salary = 1000000;
        int bonus = 200000;
        ...
        sum=sum+10;
        System.out.println("sum에 10이 있었으니 10을 추가로 더하면 값은? "+sum);

        sum=sum+10;
        System.out.println("sum에 20이 있었으니 10을 추가로 더하면 값은? "+sum);

        /*동일한 sum 이라는 변수를 세번 출력했지만, 출력하는 시점마다 수행된 연산의 결과에 따라 출력되는 sum의 값은 달라진다.*/
