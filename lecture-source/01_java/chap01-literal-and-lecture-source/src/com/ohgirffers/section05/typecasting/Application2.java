package com.ohgirffers.section05.typecasting;
...
public class Application2 {
    public static void main(String[] args) {
        ...
        * */
        ...
        /*1. 강제형변환 규칙
        *1-1. 큰자료형에서 작은 자료형으로 변경 시 강제 형변환이 필요하다.
        * 1-2. 실수를 정수로 변경시 강제 형변환이 필요하다.
        * 1-3. 문자형을 int미만 크기의 변수에 저장할 떄 강제 형변환이 필요하다.
        * 1-4. 논리형은 강제 형변환 규칙에서도 제외된다.
        *  */

        /*1-1. 큰 자료형에서 작은 자료형으로 변경 시 강제 형 변환이 필요하다.*/
        /*1-1-1. 정수 끼리의 강제 형변환*/
        long lnum=8;
//        int inum=lnum;        //데이터 손실 가능성을 컴파일러가 알려준다.
        int inum=(int) lnum;    //변겨하려는 자료형을 명시해서 강제 형변환을 해야함.
...
//        long lnum2=fnum2;
        ...
        /*추가적으로 정수를 char 자료형*에 강제 형변환해서 대입하기 테스트*/
        int num1=97;
        int num2=-97;
