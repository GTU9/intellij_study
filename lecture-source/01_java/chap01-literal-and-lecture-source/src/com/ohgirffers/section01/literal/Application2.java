...
public class Application2 {
    public static void main(String[] args) {
        /* 값을 직접  연산하여 출력할 수 있다.
        * 이 때 값의 형태에 따라 사용하 수 있는 연산자의 종류와 연산의 결과가 달라진다*/
        ...
        /*컴퓨터는 문자를 인식하지 못하고 숫자로만 인식할 수 있기 떄문에, 모든 문자에 대응되는 숫자들이 매칭이 되어 있다.*/
...
//        System.out.println("hello"%"world");
        ...
        /*주의 사항 : 숫자로 된 문자열 형태의 값은 '+' 연산의 결과가 묹열 합치기 결과가 되는 것에 주의하자! */
