...
public class UserDTO {
    ...
    * 자바코드를 모르는 웹 퍼블리셔들도 자바 코드를 사용할 수 있도록 태그 형식으로 지원하는 문법으르 의미하는데,
    ...
    * */
    ...
    /*기본 생성자 명시적으로 작성
    * 매개변수가 있는 생성자를 선택적으로 추가할 수 있도록 기본생성자를 명시한다.
    * (명시하지 않고 추후 매개변수가 있는 생성자를 추가할 시 에러 발생의 가능성이 있기 때문이다.)
    * */
