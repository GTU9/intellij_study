...
public class Application {
    public static void main(String[] args) {
        ...
        * */
        ...
        System.out.print("인자로 전달하는 값 : "+r1);
        pt.testClassTypeParameter(r1);

        /*메소드 호출 후 값 변경 확인*/
        System.out.println("변경 후 사각형의 넒이와 둘레=========================");
        r1.calcArea();
        r1.calcRound();

        /*4. 가변인자*/
        /*인자로 전달하는 값이 갯수가 정해지지 않은 경우 가변배열을 활용할 수 있다.*/
//        pt.testVariableLengthArrayParameter();            //인자가 아무것도 없는 경우 에러 발생
        ...
        * 둘 중 어떤 메소드를 호출하는 것인지에 대해 모호성이 발생했기 떄문에 에러가 나는 것이다.
