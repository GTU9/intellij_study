...
public class MemberDTO {
    ...
    *   필드에 접근해서 기록된 값을 return을 이용하여 반환하며, 이 때 반환타입은 반환하려는 값의 자료형과 일치시켜야 한다.
    * [표현식]
    * public 반환형  get필드명(){
    *   return 반환값;
    * }
