...
public class FinalFieldTest {
     ...
     * 따라서 초기 이스턴스가 생성되고 나면 기본값 0이 필드에 들어가게 되는데,
...
//    private final int nonStaticNum;
    ...
    /*static에도 자바에서 지정한 깁노값이 초기에 대입되기 때문에
    * final 키웓 사용시 초기화를 하지 않으면 에러가 발생한다.
    * */
...
//    }
    ...
    /*지금은 가능한 것만 보고 필드에 대해 조금 더 정리한 뒤 초기화 블럭에 대해 다시 살펴보자*/
    static{
        STATIC_DOUBLE=0.5;
    }
}