...
public class Application {
    public static void main(String[] args) {
        ...
        *    두 번쨰 이용 시에는 인스턴스 생성 시간 없이 사용할 수 있다.
...
//        EagerSingleton eager=new EagerSingleton();
        ...
        System.out.println("eager1의 해시코드 : "+eager1.hashCode());
        System.out.println("eager2의 해시코드 : "+eager2.hashCode());
